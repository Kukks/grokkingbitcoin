...
* <<ch12>> introduces Taproot. This 2021 upgrade gave Bitcoin a second
signature scheme (Schnorr), a new output type with hidden script trees,
and a refreshed script language. The chapter walks through how shared-
custody spends—multisig, federations, and complex contracts—are made
...
built Bitcoin. Chapters 9, 10, 11, and 12 can be read out of order, but
I recommend reading chapter 11 carefully, because it covers the essence
of Bitcoin. If you get chapter 11, you’re grokking Bitcoin. Chapter 12
builds on chapter 10, so read 10 first.
